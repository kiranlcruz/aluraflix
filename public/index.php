...
<head>
    ...
    <link rel="shortcut icon" href="../../ALURA/aluraplay/img/favicon.ico" type="image/x-icon">
</head>
    ...
    <header>
        ...
        <nav class="cabecalho">
            ...
            <div class="cabecalho__icones">
                <a href="../../ALURA/aluraplay/pages/enviar-video.html" class="cabecalho__videos"></a>
                <a href="../../ALURA/aluraplay/pages/login.html" class="cabecalho__sair">Sair</a>
            </div>
        </nav>
    ...
    <ul class="videos__container" alt="videos alura">
        <li class="videos__item">
            ...
            <div class="descricao-video">
                <img src="../../ALURA/aluraplay/img/logo.png" alt="logo canal alura">
                <h3>Qual é o melhor hardware para programação com Mario Souto</h3>
                <div class="acoes-video">
                    <a href="../../ALURA/aluraplay/pages/enviar-video.html">Editar</a>
                    <a href="../../ALURA/aluraplay/pages/enviar-video.html">Excluir</a>
                </div>
            </div>
        </li>
        <li class="videos__item">
